...
from workapp.permission import *
User = get_user_model()
...
def home_view(request):
    ...
    total_candidates = User.objects.filter(role='employee').count()+32
    total_companies = User.objects.filter(role='employer').count()+54
    ...
    'total_jobs': len(jobs)+12,
    'total_completed_jobs':len(published_jobs.filter(is_closed=True))+32,
    'page_obj': page_obj
    }
    print('ok')
    return render(request, 'workapp/index.html', context)
...
def job_list_View(request):
    ...
    return render(request, 'workapp/job-list.html', context)
...
def create_job_View(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse("workapp:single-job", kwargs={
                                    'id': instance.id
                                    }))
    ...
    return render(request, 'workapp/post-job.html', context)
...
def single_job_view(request, id):
    ...
    return render(request, 'workapp/job-single.html', context)
...
def search_result_view(request):
    ...
    return render(request, 'workapp/result.html', context)
...
def dashboard_view(request):
    ...
    return render(request, 'workapp/dashboard.html', context)
...
def delete_job_view(request, id):
    ...
    return redirect('workapp:dashboard')
...
def all_applicants_view(request, id):
    ...
    return render(request, 'workapp/all-applicants.html', context)
...
def applicant_details_view(request, id):
    ...
    return render(request, 'workapp/applicant-details.html', context)
...
def job_edit_view(request, id=id):
    ...
    return render(request, 'workapp/job-edit.html', context)

def about_us(request):
    return render(request, 'workapp/about-us.html')

def contact(request):
    return render(request, 'workapp/contact.html')
